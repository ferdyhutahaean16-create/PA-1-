            ...
            <form action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="konten" rows="10" placeholder="Tuliskan isi berita secara lengkap di sini..." class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-[#1a4a38]" required></textarea>
                    </div>
                </div>
