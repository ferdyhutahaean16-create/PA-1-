            ...
            <form action="{{ route('curriculum.store') }}" method="POST">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 mb-6">
                    ...
                    <div id="form-container" class="space-y-4">
                        <div class="flex items-start gap-4 input-row bg-gray-50 p-4 rounded-lg border border-gray-200 relative">
                            ...
                            <div class="w-1/4">
                                ...
                                <input type="text" name="course_code[]" placeholder="Contoh: TIB101" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                            </div>

                            <div class="w-2/4">
                                <label class="block text-xs font-bold text-gray-700 uppercase tracking-wide mb-2">Nama Mata Kuliah *</label>
                                <input type="text" name="course_name[]" placeholder="Contoh: Biologi Dasar" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                            </div>

                            <div class="w-1/6">
                                <label class="block text-xs font-bold text-gray-700 uppercase tracking-wide mb-2">SKS *</label>
                                <input type="number" name="credits[]" placeholder="Contoh: 3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" required>
                            </div>
