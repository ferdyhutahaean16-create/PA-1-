...
<div class="p-4 md:p-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        ...
        <a href="{{ route('research.create') }}" class="bg-[#1a4a38] hover:bg-[#0f2e22] text-white px-5 py-2.5 rounded-xl text-sm font-bold transition-all flex items-center gap-2 shadow-sm">
