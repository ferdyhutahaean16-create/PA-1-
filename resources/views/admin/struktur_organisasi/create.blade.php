...
<div class="py-10 bg-gray-50 min-h-screen">
    <div class="container mx-auto px-6 max-w-3xl">
        <div class="mb-8">
            <a href="{{ route('struktur-organisasi.index') }}" class="text-blue-600 hover:underline flex items-center gap-2 mb-4">
        ...
        <div class="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
            <form action="{{ route('struktur-organisasi.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">Jabatan <span class="text-red-500">*</span></label>
                        <input type="text" name="jabatan" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="Contoh: Ketua Program Studi" required>
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <input type="text" name="nama" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="Contoh: Dr. Arnaldo Marulitua Sinaga, S.T., M.InfoTech" required>
                </div>

                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">Foto Pejabat</label>
                    <div class="mt-1 flex items-center gap-4">
                        <input type="file" name="foto" class="w-full text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 cursor-pointer border border-gray-200 rounded-md bg-gray-50">
                    </div>
