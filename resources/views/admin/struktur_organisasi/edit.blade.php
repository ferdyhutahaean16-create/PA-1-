            ...
            <form action="{{ route('struktur-organisasi.update', $struktur->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $struktur->nama) }}" required class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-600 outline-none">
                    </div>

                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">Jabatan</label>
                        <input type="text" name="jabatan" value="{{ old('jabatan', $struktur->jabatan) }}" required class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-600 outline-none">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="file" name="foto" accept="image/jpeg,image/png,image/jpg" class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-600 outline-none bg-gray-50">
                ...
                <div class="mb-8 p-4 bg-blue-50 rounded-lg border border-blue-100 inline-block">
                    ...
                    <img src="{{ asset($struktur->foto) }}" alt="Foto {{ $struktur->nama }}" class="w-32 h-32 object-cover rounded shadow border border-white">
                </div>
                @endif
