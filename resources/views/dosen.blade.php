        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden border-t-4 border-biotech-primary hover:shadow-2xl transition transform hover:-translate-y-1">
                <div class="p-6">
                    ...
                    @if($dosen->foto) <div class="w-32 h-32 rounded-full overflow-hidden mb-4 mx-auto shadow-sm border-4 border-gray-50 object-cover">
                    ...
                    <div class="space-y-3 text-sm text-gray-600 border-t border-gray-100 pt-4">
                        <div class="flex">
                            <span class="font-bold w-28 text-gray-800 flex-shrink-0">NIDN</span>
                            <span class="flex-1">: {{ $dosen->nidn }}</span>
                        </div>
                        <div class="flex">
                            <span class="font-bold w-28 text-gray-800 flex-shrink-0">Pendidikan</span>
                            <span class="flex-1 leading-relaxed">: {{ $dosen->lulusan }}</span>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="flex-1">: {{ $dosen->no_telpon ?? '-' }}</span>
                        </div>
                        <div class="flex items-start">
                            <span class="font-bold w-28 text-gray-800 flex-shrink-0">Email</span>
                            <span class="flex-1 break-all">: <a href="mailto:{{ $dosen->email }}" class="text-blue-500 hover:underline">{{ $dosen->email }}</a></span>
                        </div>
                    </div>
                </div>
            </div>
