  ...
  <div class="services-inner">
    <div class="svc-header">
      ...
      <div style="padding-bottom:40px">
        <div class="section-tag">Administrasi</div>
        <h2 class="section-h2">Layanan Lab</h2>
      </div>
    </div>
    <div class="services-grid">
      <div class="svc-card">
        <div class="svc-tag-line">
          <span class="svc-tag-num">01</span>
          <div class="svc-tag-bar"></div>
        </div>
        <div class="svc-icon a">
          <svg width="28" height="28" fill="none" stroke="#1a4a38" viewBox="0 0 24 24" stroke-width="1.8">
            <path stroke-linecap="round" stroke-linejoin="round" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"/>
          </svg>
        </div>
        <h3 class="svc-h">Peminjaman<br>Alat</h3>
        <p class="svc-p">Ajukan permohonan peminjaman peralatan laboratorium untuk keperluan praktikum atau penelitian dengan mudah dan terdokumentasi.</p>
        <a href="{{ route('lab.pinjam-alat') }}" class="svc-btn">
          Isi Formulir
          <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
          </svg>
        </a>
        <div class="svc-corner-deco"></div>
      </div>

      <div class="svc-card">
        <div class="svc-tag-line">
          <span class="svc-tag-num">02</span>
          <div class="svc-tag-bar"></div>
        </div>
        <div class="svc-icon b">
          <svg width="28" height="28" fill="none" stroke="#6b3a8a" viewBox="0 0 24 24" stroke-width="1.8">
            <path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
          </svg>
        </div>
        <h3 class="svc-h">Pengambilan<br>Bahan</h3>
        <p class="svc-p">Ajukan permohonan pengambilan bahan kimia, reagen, atau bahan habis pakai lainnya yang tersedia di inventaris laboratorium.</p>
        <a href="{{ route('lab.pinjam-bahan') }}" class="svc-btn">
          Isi Formulir
          <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
          </svg>
...
<div class="status-section">
  <div class="status-card">
    <div class="status-left">
      <div class="status-eyebrow">Lacak Permohonan</div>
      <h2 class="status-h">Sudah Mengajukan<br>Permohonan?</h2>
      <p class="status-p">Pantau status persetujuan dari Admin secara real-time menggunakan Nomor Induk Mahasiswa (NIM) Anda.</p>
    </div>
    <a href="{{ route('lab.cek-status') }}" class="status-btn">
