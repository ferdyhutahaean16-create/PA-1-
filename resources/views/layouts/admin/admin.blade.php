    ...
    <aside class="w-64 bg-[#0f172a] text-gray-300 h-screen flex flex-col border-r border-gray-800 shrink-0 shadow-xl z-20">
        ...
        <div class="flex-1 overflow-y-auto py-6 px-4 space-y-6 custom-scrollbar">
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('admin.fasilitas.index') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm font-medium rounded-lg transition-colors {{ request()->is('admin/laboratorium*') ? 'bg-gray-800 text-white border-l-2 border-[#22c55e]' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
