    ...
    <div class="container mx-auto px-6 relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12 text-sm">
            ...
            <div class="md:col-span-5">
                ...
                <div class="flex gap-4">
                    {{-- Instagram --}}
                    <a href="https://www.instagram.com/it.del/" target="_blank" rel="noopener noreferrer" class="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:bg-[var(--gold)] hover:border-[var(--gold)] hover:text-white transition-all cursor-pointer">
                    ...
                    {{-- Facebook --}}
                    <a href="https://www.facebook.com/InstitutTeknologiDel/" target="_blank" rel="noopener noreferrer" class="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:bg-[var(--gold)] hover:border-[var(--gold)] hover:text-white transition-all cursor-pointer">
                    ...
                    {{-- TikTok --}}
                    <a href="https://www.tiktok.com/@institutteknologidel" target="_blank" rel="noopener noreferrer" class="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:bg-[var(--gold)] hover:border-[var(--gold)] hover:text-white transition-all cursor-pointer">
        ...
        <div class="mt-20 pt-8 border-t border-white/10">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <p class="text-[10px] text-green-200/40 uppercase tracking-[0.2em]">
                    Developed by <span class="text-[var(--gold)]/60">Sesilia</span>
                </p>
            </div>
        </div>
    </div>
