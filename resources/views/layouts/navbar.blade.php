...
<nav id="main-nav" class="fixed w-full top-0 z-50 shadow-md">
    <div class="container mx-auto px-4 xl:px-6 h-16 flex justify-between items-center relative">
        ...
        <div class="hidden lg:flex items-center gap-4 xl:gap-6 font-bold text-[12px] xl:text-sm uppercase tracking-wide">
            ...
            <div class="ml-4 lg:ml-8 flex items-center">
                <a href="{{ route('login') }}" class="bg-grey-500 hover:bg-yellow-600 text-white font-bold py-2 px-5 rounded-full shadow-md transition-all duration-300 flex items-center gap-2 text-sm uppercase tracking-wide border border-transparent hover:border-white/50">
