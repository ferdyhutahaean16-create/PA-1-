        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div 
                ...
                <div class="text-center flex-1 flex flex-col">
                    ...
                    {{-- TOMBOL LIHAT DOKUMEN MOU --}}
                    @if($mitra->document_file)
                    <div class="mt-5">
                        <a href="{{ asset($mitra->document_file) }}" target="_blank" class="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-[var(--forest)] text-white text-[10px] font-bold uppercase tracking-widest hover:bg-[var(--gold)] hover:text-[var(--forest-dark)] transition-all duration-300 shadow-md">
