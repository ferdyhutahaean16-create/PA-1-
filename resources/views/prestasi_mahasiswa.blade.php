            ...
            @else
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="glass-card p-8 hover-gold transition-all duration-300 flex flex-col">
                        ...
                        {{-- 💡 Menggunakan kolom 'level' dan 'date_earned' --}}
                        ...
                        <div class="flex items-center gap-4 pt-6 border-t border-gray-100 mt-auto">
                            <div class="relative">
                                {{-- 💡 Menggunakan kolom 'certificate_file' dan 'achiever_name' --}}
                                @if($item->certificate_file)
                                    <img src="{{ asset('storage/' . $item->certificate_file) }}" class="w-12 h-12 rounded-full object-cover border-2 border-[var(--gold)] shadow-sm">
                                @else
                                    <div class="w-12 h-12 rounded-full bg-[var(--forest)] flex items-center justify-center text-[var(--gold)] font-bold text-xs uppercase">
                    ...
                    <div class="glass-card overflow-hidden flex flex-col md:flex-row hover:shadow-xl transition-all">
                        ...
                        <div class="md:w-3/4 p-10 flex flex-col justify-center">
                            <div class="flex flex-wrap items-center gap-3 mb-4">
                                {{-- 💡 Menggunakan kolom 'publication_type' dan 'publication_date' --}}
