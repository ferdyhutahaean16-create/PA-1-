...
<div class="container mx-auto py-20 mt-10 min-h-screen px-6 max-w-5xl">
    ...
    {{-- Ganti bagian tengah halaman Anda dengan kode ini --}}
    ...
    @else
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            @foreach($penelitians as $item)
                <div class="bg-white border border-gray-100 rounded-3xl p-6 md:p-8 shadow-sm hover:shadow-lg transition-all duration-300 flex flex-col group">
                    ...
                    {{-- Tombol Aksi --}}
                    <div class="flex flex-wrap gap-3 mt-auto pt-5 border-t border-gray-50">
                        @if($item->file_pdf)
                        ...
                        @if($item->link_jurnal)
                            <a href="{{ $item->link_jurnal }}" target="_blank" class="inline-flex items-center gap-2 border border-gray-200 text-gray-600 px-5 py-2.5 rounded-xl text-xs font-bold hover:bg-gray-50 transition-all">
