        ...
        <div class="grid grid-cols-1 gap-16">
            ...
            <div class="faculty-card overflow-hidden">
                ...
                <div class="p-8 md:p-12">
                    ...
                    <a href="#" class="inline-flex items-center gap-2 text-gray-500 hover:text-[#1a4a38] hover:font-bold px-3 py-2 text-xs font-semibold uppercase tracking-wider transition-all">
                        {{-- Ikon Jurnal/Artikel --}}
